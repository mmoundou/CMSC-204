...
public class MorseCodeConverterTest {
	...
	@Test
        public void testConvertToEnglishString_STUDENT() {
            ...
            //STUDENT test expressions below
                
                String morseString = ".-- .... .- - / .. - / -.. --- / -... .- -... -.--";
                String morseToString = MorseCodeConverter.convertToEnglish(morseString);
                assertEquals("what it do baby", morseToString); 
            
                String morseString_ = "--. .-.. .. ... - . -. .. -. --. / .-- .. - .... / -- . .-.. .- -. .. -. / .- .-. . -. - / -.-- --- ..-"; 
                String morseToString_ = MorseCodeConverter.convertToEnglish(morseString_);
                assertEquals("glistening with melanin arent you", morseToString_);
	...
	public void testConvertToEnglishFile_STUDENT() throws FileNotFoundException {
            ...
            String fileString = "a life unexamined is a life not worth living"; 
            getFile("BlackOde.txt"); 
            String morseToEnglish = MorseCodeConverter.convertToEnglish(inputFile);
            assertEquals(fileString, morseToEnglish); 
            
            String fileString_ = "native son by richard wright"; 
            getFile("RichardWright.txt"); 
            String morseToEnglish_ = MorseCodeConverter.convertToEnglish(inputFile);
            assertEquals(fileString_, morseToEnglish_); 
